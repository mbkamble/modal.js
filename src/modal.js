class Modal {
  ...
  static KEY_MAP() {
    return {
      Backquote: { key: '`', shiftKey: '~' }, Digit1: { key: '1', shiftKey: '!' }, Digit2: { key: '2', shiftKey: '@' }, Digit3: { key: '3', shiftKey: '#' }, Digit4: { key: '4', shiftKey: '$' }, Digit5: { key: '5', shiftKey: '%' }, Digit6: { key: '6', shiftKey: '^' }, Digit7: { key: '7', shiftKey: '&' }, Digit8: { key: '8', shiftKey: '*' }, Digit9: { key: '9', shiftKey: '(' }, Digit0: { key: '0', shiftKey: ')' }, Minus: { key: '[', shiftKey: '{' }, Equal: { key: ']', shiftKey: '}' },
      KeyQ: { key: "'", shiftKey: '"' }, KeyW: { key: ',', shiftKey: '<' }, KeyE: { key: '.', shiftKey: '>' }, KeyR: { key: 'p', shiftKey: 'P' }, KeyT: { key: 'y', shiftKey: 'Y' }, KeyY: { key: 'f', shiftKey: 'F' }, KeyU: { key: 'g', shiftKey: 'G' }, KeyI: { key: 'c', shiftKey: 'C' }, KeyO: { key: 'r', shiftKey: 'R' }, KeyP: { key: 'l', shiftKey: 'L' }, BracketLeft: { key: '/', shiftKey: '?' }, BracketRight: { key: '=', shiftKey: '+' }, Backslash: { key: '\\', shiftKey: '|' },
      KeyA: { key: 'a', shiftKey: 'A' }, KeyS: { key: 'o', shiftKey: 'O' }, KeyD: { key: 'e', shiftKey: 'E' }, KeyF: { key: 'u', shiftKey: 'U' }, KeyG: { key: 'i', shiftKey: 'I' }, KeyH: { key: 'd', shiftKey: 'D' }, KeyJ: { key: 'h', shiftKey: 'H' }, KeyK: { key: 't', shiftKey: 'T' }, KeyL: { key: 'n', shiftKey: 'N' }, Semicolon: { key: 's', shiftKey: 'S' }, Quote: { key: "-", shiftKey: '_' },
      KeyZ: { key: ';', shiftKey: ':' }, KeyX: { key: 'q', shiftKey: 'Q' }, KeyC: { key: 'j', shiftKey: 'J' }, KeyV: { key: 'k', shiftKey: 'K' }, KeyB: { key: 'x', shiftKey: 'X' }, KeyN: { key: 'b', shiftKey: 'B' }, KeyM: { key: 'm', shiftKey: 'M' }, Comma: { key: 'w', shiftKey: 'W' }, Period: { key: 'v', shiftKey: 'V' }, Slash: { key: 'z', shiftKey: 'Z' }
    }
  }
